  ...
  return (
    <section className="page-section" aria-labelledby="posture-title">
      ...
      <div className="deployment-chain" aria-label="Source-only package path">
        ...
        <i aria-hidden="true">→</i>
        <div><span>03</span><strong>Runtime adapters</strong><small>Worker and portable server behavior defined in source</small></div>
        <i aria-hidden="true">→</i>
      ...
      <div className="posture-grid">
        <PostureRow
          ...
          detail="Cloudflare request metadata can expose the TLS protocol version received at the Worker."
        />
        <PostureRow
        ...
        <PostureRow
          ...
          detail="Authentication and authorization are outside this public source snapshot. No provider configuration or access outcome is represented."
        />
        <PostureRow
          label="Application storage + origin dependency"
          state="Not implemented"
          value="No external data store or upstream origin"
          detail="The Worker target is originless. The portable package self-serves embedded assets. Neither package uses KV, D1, R2, cookies, accounts, or application logs."
        />
        <PostureRow
