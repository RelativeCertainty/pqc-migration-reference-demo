  ...
  layers: [
    {
      ...
      locator: "apps/pqc-enterprise-demo/frontend/src/reference/domain/syntheticEvidence.v1.ts",
    },
    {
      id: "package-config",
      label: "Tracked package configuration",
      state: "Development evidence",
      claim: "Tracked configuration defines one C# host and one React application, including durable synthetic assessment and capacity-planning modules.",
      boundary: "Configuration and package tests do not prove that an artifact is installed, reachable, or operating in production.",
      locator: "apps/pqc-enterprise-demo/Program.cs + automated tests",
    },
    {
      id: "deployment",
      label: "Deployment",
    ...
    },
    {
      ...
      claim: "The C# loopback host observes HTTP protocol. It cannot observe upstream TLS or infer it from forwarded headers.",
